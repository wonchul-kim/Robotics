...
class CModelCommandActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CModelCommandFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CModelCommandActionFeedback(null);
    ...
    data.feedback = CModelCommandFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CModelCommandActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CModelCommandFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CModelCommandFeedback()
    }
...
module.exports = CModelCommandActionFeedback;
